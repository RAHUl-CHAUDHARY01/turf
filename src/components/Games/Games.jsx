    ...
    <div className="min-h-screen bg-black text-white font-sans">
        ...
        <div className="bg-gradient-to-r from-black via-black to-orange-900 h-96 flex items-center justify-center">
          ...
          <div className="container mx-auto px-4 z-10 text-center">
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-6">
              ...
              <button className="bg-transparent border-2 border-white hover:border-orange-500 hover:text-orange-500 font-semibold py-4 px-8 rounded-xl transition-all text-lg">
                EXPLORE FACILITIES
              </button>
            </div>
          </div>
      ...
      <footer className="bg-black text-white py-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <h3 className="text-3xl font-extrabold">
                <span>GAME</span>
                <span className="text-orange-500">ON</span>
                <span className="text-gray-500 text-sm ml-2 font-normal">TURF</span>
              </h3>
              <p className="text-gray-500 text-sm mt-2 font-light">Premium sports facilities since 2020</p>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-800 text-sm text-gray-400 text-center font-light">
            © 2025 GameOn Turf. All rights reserved. | Designed with passion for sports
          </div>
        </div>
      </footer>
